...
var HTMLmobile = '<li class="flex-item"><span class="teal-text align-right">mobile</span><span class="white-text">%data%</span></li>';
...
var HTMLlinkedin = '<li class="flex-item"><span class="teal-text">linkedin</span><span class="white-text">%data%</span></li>';
...
var HTMLwelcomeMsg = '<br><br><span class="welcome-message">%data%</span><br>';
...
var HTMLschoolDescription = '<p>%data%</p><br>';

var HTMLonlineCourses = '<h3>Certifications</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = '<div><em>%data%</em></div>';
